...
public class InfantFrame extends JFrame
{
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (returnVal == JFileChooser.APPROVE_OPTION) {
                        ...
                        try {
                            ...
                            // TODO: No data loaded then open a message dialog box to indicate an error
    ...
    private class SelectionPanel extends JPanel
    {
        ...
        private SelectionPanel()
        {
            ...
            trialList.addListSelectionListener(null);
            fieldList.addListSelectionListener(null);
            subfieldList.addListSelectionListener(null);
    ...
    private class DataPanel extends JPanel
    {
        ...
        // TODO: complete implementation of JTextfield
    ...
    {
        // TODO: implement I think we load into infant
